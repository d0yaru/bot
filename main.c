...
void SendMessage(int chat_id, char[] msg) {
   ...
   //Создадим шаблон HTTP запроса для отправки сообщения, в виде форматированной строки
    char header[] = "POST /bot479650755:AAFo4mbgWIZkKCmlpGF_6lkagfCfSnlnLz4/sendMessage HTTP/1.1\r\nHost: files.ctrl.uz\r\nContent-Type: application/json\r\nContent-Length: %d\r\nConnection: close\r\n\r\n%s";
...
// Сохраняем файл в одной папке с сертификатом, компилируем любым компилятором и запускаем
